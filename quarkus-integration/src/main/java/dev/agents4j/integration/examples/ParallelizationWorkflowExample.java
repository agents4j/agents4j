...
public class ParallelizationWorkflowExample {
    ...
    @ConfigProperty(
        name = "agents4j.parallelization.enabled",
        defaultValue = "true"
    )
    ...
    public String sentimentAnalysisExample() {
        ...
        try {
            ParallelizationWorkflow workflow =
                AgentWorkflowFactory.createParallelizationWorkflow(
                    "SentimentAnalysis",
                    chatModel
                );
            ...
            String results =
                "Sentiment analysis completed for " + texts.size() + " texts";
    ...
    public String documentTranslationExample() {
        ...
        try {
            ...
            String document =
                "Welcome to our innovative platform for AI-powered workflows.";

            String results =
                "Document translated to " + languages.size() + " languages";
            System.out.println("Results: " + results);
            return results;
        } catch (Exception e) {
    ...
    public String contentGenerationExample() {
        ...
        try {
            ...
            String results =
                "Content generated for " + topics.size() + " topics";
            System.out.println("Results: " + results);
            return results;
        } catch (Exception e) {
    ...
    public CompletableFuture<String> asyncProcessingExample() {
        if (!parallelizationEnabled) {
            return CompletableFuture.completedFuture(
                "Parallelization workflow is disabled"
            );
        }
    ...
    public String performanceComparisonExample() {
        ...
        try {
            ...
            System.err.println(
                "Performance comparison failed: " + e.getMessage()
            );
            return "Error: " + e.getMessage();
        }
    }
