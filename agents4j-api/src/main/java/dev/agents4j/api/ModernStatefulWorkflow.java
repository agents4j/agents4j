 ...
 */
public interface ModernStatefulWorkflow<S, O> {
     ...
     * @return A WorkflowResult containing the execution outcome
     */
    default WorkflowResult<WorkflowExecution<S, O>, WorkflowError> start(S initialStateData) {
     ...
     * @return A WorkflowResult containing the execution outcome
     */
    WorkflowResult<WorkflowExecution<S, O>, WorkflowError> start(S initialStateData, WorkflowContext initialContext);
     ...
     * @return A WorkflowResult containing the execution outcome
     */
    WorkflowResult<WorkflowExecution<S, O>, WorkflowError> resume(WorkflowExecution<S, O> execution);
     ...
     * @return A WorkflowResult containing the execution outcome
     */
    WorkflowResult<WorkflowExecution<S, O>, WorkflowError> resume(WorkflowExecution<S, O> execution, WorkflowContext contextUpdates);
     ...
     */
    default CompletableFuture<WorkflowResult<WorkflowExecution<S, O>, WorkflowError>> startAsync(S initialStateData, WorkflowContext initialContext) {
        return CompletableFuture.supplyAsync(() -> start(initialStateData, initialContext));
    }
     ...
     * @return A CompletableFuture containing the execution result
     */
    default CompletableFuture<WorkflowResult<WorkflowExecution<S, O>, WorkflowError>> resumeAsync(WorkflowExecution<S, O> execution) {
    ...
    default WorkflowResult<S, WorkflowError> validate(S stateData) {
        if (stateData == null) {
            return WorkflowResult.suspended("validation-failed", null, "Workflow state data is required");
        }
    ...
    sealed interface WorkflowExecution<S, O> 
        permits WorkflowExecution.Completed, WorkflowExecution.Suspended, WorkflowExecution.Failed {
        ...
        record Completed<S, O>(
            ...
            public Completed {
                java.util.Objects.requireNonNull(stateData, "State data cannot be null");
                java.util.Objects.requireNonNull(context, "Context cannot be null");
                java.util.Objects.requireNonNull(executionId, "Execution ID cannot be null");
                java.util.Objects.requireNonNull(timestamp, "Timestamp cannot be null");
                java.util.Objects.requireNonNull(output, "Output cannot be null");
            }
            
            @Override
            public S getStateData() { return stateData; }
        ...
        record Suspended<S, O>(
            ...
            public Suspended {
                ...
                java.util.Objects.requireNonNull(executionId, "Execution ID cannot be null");
                java.util.Objects.requireNonNull(timestamp, "Timestamp cannot be null");
                java.util.Objects.requireNonNull(suspensionId, "Suspension ID cannot be null");
                java.util.Objects.requireNonNull(reason, "Suspension reason cannot be null");
                java.util.Objects.requireNonNull(timeout, "Timeout optional cannot be null");
            }
         ...
         */
        static <S, O> WorkflowExecution<S, O> completed(S stateData, WorkflowContext context, String executionId, O output) {
            return new Completed<>(stateData, context, executionId, java.time.Instant.now(), output);
        }
         ...
         */
        static <S, O> WorkflowExecution<S, O> suspended(S stateData, WorkflowContext context, String executionId, 
                                                       String suspensionId, String reason) {
            return new Suspended<>(stateData, context, executionId, java.time.Instant.now(), 
                                 suspensionId, reason, java.util.Optional.empty());
        }
         ...
         * @return A suspended execution
         */
        static <S, O> WorkflowExecution<S, O> suspendedWithTimeout(S stateData, WorkflowContext context, String executionId,
                                                                  String suspensionId, String reason, java.time.Duration timeout) {
            return new Suspended<>(stateData, context, executionId, java.time.Instant.now(), 
                                 suspensionId, reason, java.util.Optional.of(timeout));
        }
         ...
         */
        static <S, O> WorkflowExecution<S, O> failed(S stateData, WorkflowContext context, String executionId, WorkflowError error) {
            return new Failed<>(stateData, context, executionId, java.time.Instant.now(), error, error.isRecoverable());
        }
    }
    ...
    record WorkflowMetadata(
        ...
        public WorkflowMetadata {
            java.util.Objects.requireNonNull(workflowId, "Workflow ID cannot be null");
            java.util.Objects.requireNonNull(name, "Workflow name cannot be null");
            java.util.Objects.requireNonNull(version, "Workflow version cannot be null");
            java.util.Objects.requireNonNull(stateType, "State type cannot be null");
            java.util.Objects.requireNonNull(outputType, "Output type cannot be null");
        }
    }
}