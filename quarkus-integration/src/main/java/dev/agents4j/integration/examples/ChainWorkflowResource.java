...
public class ChainWorkflowResource {
    ...
    public Response simpleChainQuery(SimpleChainRequest request) {
        ...
        try {
            ...
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity(Map.of("error", "Failed to execute simple chain query: " + e.getMessage()))
                    .build();
        }
    }
    ...
    public Response complexChainQuery(ComplexChainRequest request) {
        ...
        try {
            ...
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity(Map.of("error", "Failed to execute complex chain query: " + e.getMessage()))
                    .build();
        }
    }
    ...
    public Response threeWhysAnalysis(ThreeWhysRequest request) {
        ...
        try {
            ...
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity(Map.of("error", "Failed to execute three whys analysis: " + e.getMessage()))
                    .build();
        }
    }
    ...
    public Response conversationalQuery(ConversationalRequest request) {
        ...
        try {
            ...
            response.put("max_messages", request.getMaxMessages() != null ? request.getMaxMessages() : 10);
            
            return Response.ok(response).build();
        } catch (Exception e) {
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity(Map.of("error", "Failed to execute conversational query: " + e.getMessage()))
                    .build();
        }
    }
    ...
    public Response getChainWorkflowTypes() {
        ...
        examples.put("available_examples", List.of("simple", "complex", "three-whys", "conversational"));
