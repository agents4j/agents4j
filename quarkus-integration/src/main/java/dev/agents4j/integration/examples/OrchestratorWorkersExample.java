...
public class OrchestratorWorkersExample {
    ...
    @ConfigProperty(
        name = "agents4j.orchestrator.enabled",
        defaultValue = "true"
    )
    ...
    public String simpleOrchestrationExample() {
        ...
        String task =
            "Analyze the potential impact of renewable energy adoption on the economy";

        try {
            OrchestratorWorkersWorkflow workflow =
                AgentWorkflowFactory.createStandardOrchestratorWorkersWorkflow(
                    "SimpleOrchestrator",
                    chatModel
                );
            ...
            String output = result.isCompleted()
            ...
            System.err.println(
                "Simple orchestration failed: " + e.getMessage()
            );
    ...
    public String businessAnalysisExample() {
        ...
        try {
            ...
            String businessQuery =
                "Evaluate market opportunities for electric vehicle charging infrastructure";
            OrchestratorWorkersWorkflow.OrchestratorInput input =
                new OrchestratorWorkersWorkflow.OrchestratorInput(
                    businessQuery,
                    Map.of()
            ...
            StatefulWorkflowResult<
                OrchestratorWorkersWorkflow.WorkerResponse
            > result = workflow.start(input);
            String analysis = result.isCompleted()
    ...
    public String advancedWorkflowExample() {
        ...
        try {
            ...
            String complexTask =
                "Our company is considering entering the electric vehicle market. " +
            ...
            StatefulWorkflowResult<
                OrchestratorWorkersWorkflow.WorkerResponse
            > result = workflow.start(input);
            String response = result.isCompleted()
    ...
    public String multiPerspectiveExample() {
        ...
        try {
            ...
            System.out.println(
                "Multi-perspective analysis result: " + analysis
            );
            return analysis;
        } catch (Exception e) {
            System.err.println(
                "Multi-perspective analysis failed: " + e.getMessage()
            );
            return "Error: " + e.getMessage();
        }
    }
    ...
    public String contentCreationExample() {
        ...
        try {
            ...
            StatefulWorkflowResult<
                OrchestratorWorkersWorkflow.WorkerResponse
            > result = workflow.start(input);
            String content = result.isCompleted()
    ...
    public boolean isWorkflowHealthy() {
        ...
        try {
            ...
            System.err.println(
                "Workflow health check failed: " + e.getMessage()
            );
            return false;
        }
    }
